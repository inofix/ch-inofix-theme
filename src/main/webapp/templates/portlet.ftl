<#--
    ...
    Modified:   2017-10-12 15:47 by Christian Berndt
    Version:    1.0.3
-->
...
<#elseif request.getAttribute("_ch_inofix_data_web_internal_portlet_DataManagerPortlet_showTitle")??>
    <#assign show_title = request.getAttribute("_ch_inofix_data_web_internal_portlet_DataManagerPortlet_showTitle") />
